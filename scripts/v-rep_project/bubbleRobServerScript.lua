...
if (pluginNotFound) then
    ...
    result = simLaunchExecutable("/home/diego/anaconda3/bin/python", "programming/remoteApiBindings/python/python/bubbleRobClientPy.py "..portNb.." "..leftMotor.." "..rightMotor.." "..noseSensor, 0)
    if (result==-1) then
